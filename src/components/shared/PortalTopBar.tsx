...
// event) and "Join office hours" (the existing Zoom link). No new features.
export default function PortalTopBar({ topline, zoomLink }: { topline: string; zoomLink?: string | null }) {
  return (
