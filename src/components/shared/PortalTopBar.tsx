...
import MemberNotificationBell from '@/components/dashboard/MemberNotificationBell'
...
// event) and "Join office hours" (the existing Zoom link). Admins get the
// achievements activity bell; members get their own achievement bell. No new
// features.
export default function PortalTopBar({ topline, zoomLink, showNotifications = false, memberBell = false }: { topline: string; zoomLink?: string | null; showNotifications?: boolean; memberBell?: boolean }) {
  return (
    <div className="hidden md:flex items-center justify-between gap-6 px-10 py-[18px] border-b border-[var(--border-color)] bg-[var(--bg)] sticky top-0 z-[5]">
      ...
      <div className="flex items-center gap-2.5 flex-none">
        ...
        {memberBell && <MemberNotificationBell />}
        <button
          type="button"
