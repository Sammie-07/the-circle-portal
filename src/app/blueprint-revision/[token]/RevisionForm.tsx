...
const QUESTIONS: { key: string; question: string; placeholder: string; note?: string }[] = [
  ...
  {
    key: 'tradeoffs',
    question: 'What needs to change in your setup to make this a successful year, something to add, or something to stop or pause?',
    placeholder: "Either one works. Maybe something to ADD (e.g. find, hire and train a VA, a new tool, a new lead source), or something to STOP or pause to make room. Be as detailed as you can…",
  },
]
