...
export default async function BlueprintPage() {
  ...
  // If published, redirect straight to the full standalone blueprint
  if (isPublished && member.blueprint_share_token) {
    redirect(`/b/${member.blueprint_share_token}`)
  }

  // Not published yet — show the "coming soon" state
  return (
