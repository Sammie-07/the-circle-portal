    ...
    <div className="p-8 max-w-3xl">
      ...
      {!reports || reports.length === 0 ? (
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded p-8 text-center">
          ...
          <h2 className="text-white font-serif text-lg mb-2">No Reports Yet</h2>
        ...
        <div className="space-y-3">
          {reports.map((report) => (
            <Link
              ...
              className="block bg-[#1A1A1A] border border-[#2A2A2A] rounded p-5 hover:border-[#C9A227]/30 transition-all group"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-white font-serif text-lg group-hover:text-[#C9A227] transition-colors">
                    {report.period_label}
                  </h3>
                ...
                <span className="text-[#555] group-hover:text-[#C9A227] text-lg transition-colors">→</span>
              </div>
            </Link>
          ))}
        </div>
