...
Match format to substance: a single stat, milestone, or quote is usually a "single"; a multi-step teaching or a story that unfolds is a "carousel". Pick what serves this specific win.
...
- slides: SINGLE = exactly ONE slide. CAROUSEL = 4-7 slides, slide 1 the hook cover, each with a SHORT headline (<=6 words), a 1-2 sentence body, and imageDirection for that slide's visual.
- artDirection: the visual style for the designer (deep near-black background, gold #C9A227 accents, elegant serif headlines, clean sans body). Vary the composition post to post; do not describe the same layout every time.
